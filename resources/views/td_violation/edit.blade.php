    ...
    <section class="content home">
        <div class="container">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12">
                        <ul class="breadcrumb float-md-right padding-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('td_violation.index') }}">Меҳнат интизоми бўйича бахолаш</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="clearfix m-b-20">
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-right">
                            <a class="btn btn-info" href="{{ route('td_violation.index') }}"> Ортга кайтиш</a>
                        </div>
                    </div>
                </div>
                ...
                @endif
                <form action="{{ route('td_violation.update', $tdViolation->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        ...
                        <select class="form-control" name="id_td">
                            @foreach($tds as $td)
                                <option @if($tdViolation->id_td == $td->id) selected
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="user_id">
                            ...
                            @foreach($users as $user)
                                <option @if($tdViolation->user_id == $user->id) selected @endif
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" placeholder="Изох"
                                  name="description">{{$tdViolation->description}}</textarea>
                    </div>
