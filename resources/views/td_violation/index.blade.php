                ...
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-right">
                            <a class="btn btn-primary" href="{{ route('td_violation.create') }}"> Қўшиш</a>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    @foreach ($td_violations as $index=>$td_violation )
                        ...
                        <tr>
                            ...
                            <td>{{  date('Y-m-d H:i', strtotime($td_violation->datetime)) }}</td>
                            <td>
                                <a class="btn btn-sm btn-primary"
                                   href="{{ route('td_violation.edit',$td_violation->id) }}">Таҳрирлаш</a>
                                <button class="btn btn-sm btn-danger"
                                        onclick="loadDeleteModal({{ $td_violation->id }})">Ўчириш
                                </button>
                            </td>
                        </tr>
                    @endforeach
