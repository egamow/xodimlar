@extends('layout')
@section('title')Техника хафсизлиги бўйича қоидабузарлик қўшиш
@endsection
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12">
                        <ul class="breadcrumb float-md-right padding-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('tbs.index') }}">Техника хафсизлиги
                                    бўйича қоидабузарликлар</a></li>
                        </ul>
                    </div>
                </div>
            </div>
