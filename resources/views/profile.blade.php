            ...
            <div class="col-lg-12 col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-12 user_earnings">
                                <h6>Рейтинг</h6>
                                    ...
                                    <input type="text" class="knob" value="89" data-width="80" data-height="80" data-thickness="0.1" data-bgcolor="#485058" data-fgColor="#f97c53">
                                    <span>Умумий ўртача 89% <i class="zmdi zmdi-caret-up text-success"></i></span>
                            </div>
                        </div>
                    </div>
                    <ul class="nav nav-tabs profile_tab">
                        <li class="nav-item"><a class="nav-link  active" data-toggle="tab" href="#usersettings">Созламалар</a></li>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="usersettings">
                        <div class="card">
                            <div class="header">
                                <h2><strong>Хавфсизлик</strong> Созламалари</h2>
                            </div>
                            <div class="body">
                                <div class="form-group">
                                    <input type="text" readonly class="form-control" placeholder="Табел рақамингиз" title="Табел рақамингиз">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control" placeholder="Жорий парол" title="Жорий парол">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control" placeholder="Янги парол" title="Янги парол">
                                </div>
                                <button class="btn btn-info btn-round">Ўзгартиришларни сақлаш</button>
                            </div>
                        </div>
                        <div class="card">
                            <div class="header">
                                <h2><strong>Аккаунт</strong> Созламалари</h2>
                            </div>
                            <div class="body">
                                <div class="row clearfix">
                                    <div class="col-lg-4 col-md-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Исмингиз" title="Исмингиз">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Фамилиянгиз" title="Фамилиянгиз">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Телефон рақамингиз" title="Телефон рақамингиз">
                                        </div>
                                    </div>

                                    <div class="col-lg-4 col-md-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Вилоят">
                                        </div>
                                    </div>

                                    <div class="col-lg-4 col-md-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Шаҳар ёки туман" title="Шаҳар ёки туман">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <textarea rows="4" class="form-control no-resize" placeholder="Манзил" title="Манзил"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="checkbox">
                                            <input id="procheck2" type="checkbox">
                                            <label for="procheck2">Янги хабарлар хақида огоҳлантириш</label>
                                        </div>
                                        <div class="checkbox">
                                            <input id="procheck3" type="checkbox">
                                            <label for="procheck3">Қоидабузарликлар хақида огоҳлантириш</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <button class="btn btn-primary btn-round">Ўзгартиришларни сақлаш</button>
                                    </div>
                                </div>
                            </div>
                        </div>
