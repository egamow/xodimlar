                ...
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-right">
                            <a class="btn btn-primary" href="{{ route('tb_violation.create') }}"> Қўшиш</a>
                        </div>
                    </div>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-primary"
                                   href="{{ route('tb_violation.edit',$tb_violation->id) }}">Таҳрирлаш</a>
                                <button class="btn btn-sm btn-danger"
                                        onclick="loadDeleteModal({{ $tb_violation->id }})">Ўчириш
                                </button>
                            </td>
                        </tr>
                    @endforeach
