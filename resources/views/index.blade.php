    ...
    <ul class="nav navbar-nav">
        <li>
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.blade.php"><img src="assets/images/logo-black.svg" width="35" alt="Alpino"><span class="m-l-10">Alpino</span></a>
            </div>
        </li>
        <li class="search_bar">
...
<div class="menu-container">
    <div class="container">
        <div class="row">
            <div class="col-md-12">                
                <ul class="h-menu">
                    <li class="open active"><a href="index.blade.php"><i class="zmdi zmdi-home"></i></a></li>
