    ...
    <section class="content home">
        <div class="container">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12">
                        <ul class="breadcrumb float-md-right padding-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('ids.index') }}">Ижро интизоми бўйича қоидабузарликлар</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="clearfix m-b-20">
                ...
                @endif
                <form action="{{ route('ids.update', $id->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" value="{{$id->ball}}"
