...
@section('main_content')
                ...
                <table class="table table-striped table-bordered">
                    ...
                    @foreach ($id_violations as $index=>$id_violation )
                        <tr>
                            ...
                            <td>{{ $id_violation->created_at ? date('Y-m-d', strtotime($id_violation->created_at)) : ''}}</td>
                            <td class="text-center">
                                <a class="btn btn-sm btn-primary" onclick="loadEditModal({{ $id_violation->id }})"
                                   href="#"><i class="zmdi zmdi-edit"></i></a>
                                <button class="btn btn-sm btn-danger"
                                        onclick="loadDeleteModal({{ $id_violation->id }})"><i
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{route('id_violation.store')}}" method="POST">
                    @csrf
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select required class="form-control show-tick" name="id_id" data-live-search="true">
            ...
            <div class="modal-content">
                <form action="" method="POST" id="editFormClient">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="id_id">Қоидабузарлик тури</label>
                            <select required class="form-control show-tick" id="id_id" name="id_id"
    ...
    <script>
        function loadEditModal(id) {
            var route = '{{ route("id_violation.show", ":id") }}';
            var action_route = '{{ route("id_violation.update", ":id_update") }}';
            ...
            $.get(route, function (data) {
                ...
                $('select[name=id_id]').val(data.id_id);
