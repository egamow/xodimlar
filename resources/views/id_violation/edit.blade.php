    ...
    <section class="content home">
        <div class="container">
            ...
            <div class="clearfix m-b-20">
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-right">
                            <a class="btn btn-info" href="{{ route('id_violation.index') }}"> Ортга кайтиш</a>
                        </div>
                    </div>
                </div>
                ...
                @endif
                <form action="{{ route('id_violation.update', $idViolation->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" placeholder="Изох"
                                  name="description">{{$idViolation->description}}</textarea>
                    </div>
