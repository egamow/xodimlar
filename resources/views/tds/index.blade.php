@extends('layout')
@section('title')Меҳнат интизоми бўйича қоидабузарликлар@endsection
@section('main_content')
            ...
            <div class="block-header">
                <div class="row clearfix">
                    <div class="col-lg-5 col-md-5 col-sm-12">
                        <h2>Меҳнат интизоми бўйича қоидабузарликлар</h2>
                    </div>
                    <div class="col-lg-7 col-md-7 col-sm-12">
                        <ul class="breadcrumb float-md-right padding-0">
                            <li class="breadcrumb-item"><a href="#"><i class="zmdi zmdi-home"></i></a></li>
                            <li class="breadcrumb-item active">Меҳнат интизоми бўйича қоидабузарликлар</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    @foreach ($tds as $index=>$td )
                        <tr>
                            ...
                            @if (auth()->user()->admin)
                                <td>
                                    <a class="btn btn-sm btn-primary" onclick="loadEditModal({{ $td->id }})"
                                       href="#"><i class="zmdi zmdi-edit"></i></a>
                                    <button class="btn btn-sm btn-danger"
                                            onclick="loadDeleteModal({{ $td->id }})"><i
    ...
    <script>
        function loadEditModal(id) {
            var route = '{{ route("tds.show", ":id") }}';
            var action_route = '{{ route("tds.update", ":id_update") }}';
    ...
    <script>
        function loadDeleteModal(id) {
            var route = '{{ route("tds.destroy", ":td") }}';
            route = route.replace(':td', id);
