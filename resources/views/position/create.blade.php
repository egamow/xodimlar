                ...
                <div class="row clearfix">
                    <div class="col-lg-7 col-md-7 col-sm-12">
                        <ul class="breadcrumb float-md-right padding-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('position.index', $department->id) }}">
                                    Штатлар</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-right">
                            <a class="btn btn-info" href="{{ route('position.index', $department->id) }}"> Ортга
                                кайтиш</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 col-md-12 margin-tb">
                        ...
                        <form action="{{ route('position.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control" placeholder="Номи" name="name">
                                <input hidden name="type" value="p">
                                <input hidden name="pid" value="{{ $department->id }}">
                            </div>
                            <div class="form-group">
